...
import { cartTrackerSlider } from '../api/fiortech';
        ...
        >
          ...
          <div className="absolute top-0 inset-x-0 z-[110] p-6 flex items-center justify-between bg-gradient-to-b from-black/80 to-transparent backdrop-blur-sm">
            <div className="flex items-center gap-4">
              <div className="h-10 w-1 bg-[#ffcc00] rounded-full" />
              <div>
                <h3 className="text-[10px] font-black text-[#ffcc00] uppercase tracking-[0.3em]">Project Gallery</h3>
                <p className="text-sm font-bold text-white uppercase tracking-tighter italic">Bandstand</p>
              </div>
            </div>
          ...
          >
            ...
            >
              {cartTrackerSlider.map((item, index) => (
